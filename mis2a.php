...
<script>
		...
		function change2() {
  			...
  			document.getElementById("h2text").innerText = "Wan-Cin Wu";
		}
	</script>
...
<table width="70%" border="1">
	<tr>
        <td>
	          ...
	          E-Mail: <a href="mailto:s1130314@o365st.pu.edu.tw">s1130314@o365st.pu.edu.tw</a><br>
	    </td>
